  ...
  if (isNetworkTrackingEnabled(config.autocapture)) {
    ...
    return __assign(__assign({}, networkTrackingConfig), { captureRules: (_a = networkTrackingConfig === null || networkTrackingConfig === void 0 ? void 0 : networkTrackingConfig.captureRules) === null || _a === void 0 ? void 0 : _a.map(function(rule) {
      ...
      if (((_a2 = rule.urls) === null || _a2 === void 0 ? void 0 : _a2.length) && ((_b = rule.hosts) === null || _b === void 0 ? void 0 : _b.length)) {
        ...
        return __assign(__assign({}, rule), { hosts: void 0 });
      }
      return rule;
    }) });
  }
      ...
      switch (_3.label) {
        ...
        case 7:
          ...
          browserConfig = new BrowserConfig(
            ...
            amplitudeInstance._diagnosticsSampleRate,
            // Use _diagnosticsSampleRate set via _setDiagnosticsSampleRate() or defaults to 0
            void 0,
            // diagnosticsClient - set after config creation
        ...
        var _loop_1 = function(hierarchyNode2) {
          if (hierarchyNode2 === null || hierarchyNode2 === void 0 ? void 0 : hierarchyNode2.attrs) {
            Object.entries(hierarchyNode2.attrs).forEach(function(_a3) {
              var _b3 = __read(_a3, 2), key = _b3[0], value = _b3[1];
...
var createClickObservable = function(clickType) {
  ...
  return new Observable(function(observer) {
    ...
    return function() {
      var _a2;
      (_a2 = getGlobalScope()) === null || _a2 === void 0 ? void 0 : _a2.document.removeEventListener(clickType, handler, { capture: true });
    };
  });
};
    ...
    return __awaiter(void 0, void 0, void 0, function() {
      ...
      return __generator(this, function(_c2) {
        ...
        if (window.opener && visualTaggingOptions.enabled) {
          ...
          (_b2 = visualTaggingOptions.messenger) === null || _b2 === void 0 ? void 0 : _b2.setup(__assign(__assign({ dataExtractor, logger: config === null || config === void 0 ? void 0 : config.loggerProvider }, (config === null || config === void 0 ? void 0 : config.serverZone) && { endpoint: AMPLITUDE_ORIGINS_MAP[config.serverZone] }), { isElementSelectable: createShouldTrackEvent(options, __spreadArray(__spreadArray([], __read(allowlist), false), __read(actionClickAllowlist), false)), cssSelectorAllowlist: allowlist, actionClickAllowlist }));
        }
        return [
          2
          /*return*/
...
function trackDeadClick(_a) {
  ...
  var clickObservable = allObservables.clickObservable, mutationObservable = allObservables.mutationObservable, navigateObservable = allObservables.navigateObservable;
  var filteredClickObservable = clickObservable.filter(function(click) {
    return filterOutNonTrackableEvents(click) && shouldTrackDeadClick("click", click.closestTrackedAncestor) && click.event.target instanceof Element && click.event.target.closest('a[target="_blank"]') === null;
  });
...
function getRageClickAnalyticsEvent(clickWindow) {
  ...
  var rageClickEvent = __assign({ "[Amplitude] Begin Time": new Date(firstClick.timestamp).toISOString(), "[Amplitude] End Time": new Date(lastClick.timestamp).toISOString(), "[Amplitude] Duration": lastClick.timestamp - firstClick.timestamp, "[Amplitude] Clicks": clickWindow.map(function(click) {
    return {
...
var frustrationPlugin = function(options) {
  ...
  var createObservables = function() {
    ...
    return _a2 = {}, _a2[ObservablesEnum.ClickObservable] = clickObservable, _a2[ObservablesEnum.MutationObservable] = enrichedMutationObservable, _a2[ObservablesEnum.NavigateObservable] = enrichedNavigateObservable, _a2;
  };
  var setup = function(config, amplitude) {
    return __awaiter(void 0, void 0, void 0, function() {
...
function isStatusCodeInRange(statusCode, range) {
  ...
  try {
    for (var ranges_1 = __values(ranges), ranges_1_1 = ranges_1.next(); !ranges_1_1.done; ranges_1_1 = ranges_1.next()) {
      ...
      var _b = __read(r2.split("-").map(Number), 2), start = _b[0], end = _b[1];
...
function parseHeaderCaptureRule(rule) {
  if (typeof rule !== "object" || rule === null) {
    if (rule) {
      ...
      var res = IS_HEADER_CAPTURE_EXPERIMENTAL ? void 0 : __spreadArray([], __read(SAFE_HEADERS), false);
      return res;
    }
    return;
  }
        ...
        return __generator(this, function(_e) {
          switch (_e.label) {
            ...
            case 19:
              ...
              _e.label = 20;
            case 20:
              if (!isFrustrationInteractionsEnabled(this.config.autocapture)) return [3, 22];
            ...
            case 21:
              ...
              _e.label = 22;
            case 22:
              if (!isNetworkTrackingEnabled(this.config.autocapture)) return [3, 24];
            ...
            case 23:
              ...
              _e.label = 24;
            case 24:
              if (!isWebVitalsEnabled(this.config.autocapture)) return [3, 26];
            ...
            case 25:
              ...
              _e.label = 26;
            case 26:
              if (!isPageUrlEnrichmentEnabled(this.config.autocapture)) return [3, 28];
            ...
            case 29:
              ...
              connector.eventBridge.setEventReceiver(function(event) {
                var _a2 = event.eventProperties || {}, time = _a2.time, cleanEventProperties = __rest(_a2, ["time"]);
